...
model = dict(
    ...
    backbone=dict(
        ...
        extra=dict(
            ...
            num_stages=3,
            stages_spec=dict(
                num_modules=(3, 8, 3), # was (3, 8, 3)
                num_branches=(2, 3, 4),
                num_blocks=(2, 2, 2), # was (2, 2, 2)
                module_type=('LITE', 'LITE', 'LITE'),
                with_fuse=(True, True, True),
                expansion_ratios=(4, 4, 4),
                squeeze_excitation=(False, False, False),
                reduce_ratios=(4, 4, 4),
                num_channels=(
                    (40, 80),
                    (40, 80, 160),
...
data_root = '/home/esraa/Desktop/codes/datasets/mpii_human_pose_v1'
data = dict(
    samples_per_gpu=16,
    workers_per_gpu=2,
